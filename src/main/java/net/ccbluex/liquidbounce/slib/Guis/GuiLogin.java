...
public class GuiLogin extends GuiScreen {
    ...
    public static String version = (LiquidBounce.getVERIFY());
    ...
    public static String Now = LiquidBounce.getVERIFY() + "-Cracked Login";
    public GuiScreen prevGui;
    public int verifytimes = 5;
    public static String Network = "FUCKYOU";
    ...
    public void initGui() {
        if (bypass) {//
            //Display.setTitle(Now);
            Minecraft.getMinecraft().displayGuiScreen(new GuiLaunchOptionSelectMenu());//
            LiquidBounce.mainMenu = new GuiLaunchOptionSelectMenu();//
        } else {   //
            super.initGui();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        mc.getTextureManager().bindTexture(new ResourceLocation("fixxed/imgs/background.jpg"));
    ...
    private void verify() {
        try {
            ...
            if (!username.getText().isEmpty() && !password.getText().isEmpty() && !HWID.isEmpty()) {
                ...
                if (HttpUtils2.get(Network).contains(Banned)) {
                    JOptionPane.showMessageDialog(null,"ERROR:This account had been banned!");
                }
                if (HttpUtils2.get(Network).contains(Verify)) {
