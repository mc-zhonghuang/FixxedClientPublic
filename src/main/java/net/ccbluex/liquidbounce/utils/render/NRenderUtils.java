...
public final class NRenderUtils extends MinecraftInstance {
    ...
    public static void quickDrawHead(ResourceLocation skin, int x, int y, int width, int height) {
        mc.getTextureManager().bindTexture(skin);
        NRenderUtils.drawScaledCustomSizeModalRect(x, y, 8F, 8F, 8, 8, width, height,
                64F, 64F);
        NRenderUtils.drawScaledCustomSizeModalRect(x, y, 40F, 8F, 8, 8, width, height,
                64F, 64F);
    }
    ...
    public static void drawImage(ResourceLocation image, double x, double y, double width, double height, int color) {
        ...
        NRenderUtils.drawModalRectWithCustomSizedTexture((float)x, (float)y, 0.0f, 0.0f, (float)width, (float)height, (float)width, (float)height);
        GL11.glDepthMask(true);
        GL11.glDisable(3042);
        GL11.glEnable(2929);
    ...
    public static void drawTexturedRect(float x, float y, float width, float height, String image) {
        ...
        mc.getTextureManager().bindTexture(new ResourceLocation("fixxed/effects/" + image + ".png"));
        GlStateManager.color(1F, 1F, 1F, 1F);
        NRenderUtils.drawModalRectWithCustomSizedTexture(x, y, 0, 0, width, height, width, height);
    ...
    public static void rectangleBordered(double x, double y, double x1, double y1, double width, int internalColor,
                                         int borderColor) {
        NRenderUtils.rectangle(x + width, y + width, x1 - width, y1 - width, internalColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        NRenderUtils.rectangle(x + width, y, x1 - width, y + width, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        NRenderUtils.rectangle(x, y, x + width, y1, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        NRenderUtils.rectangle(x1 - width, y, x1, y1, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        NRenderUtils.rectangle(x + width, y1 - width, x1 - width, y1, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
    }
    public static void Gamesense(double x, double y, double x1, double y1, double size , float color1, float color2 , float color3) {
        NRenderUtils.rectangleBordered(x, y, x1 + size, y1 + size, 0.5d, Colors2.getColor(90), Colors2.getColor(0));
        NRenderUtils.rectangleBordered(x + 1.0f, y + 1.0f, (x1 + size - 1.0f), y1 + size - 1.0f, 1.0, Colors2.getColor(90),
                Colors2.getColor(61));
        NRenderUtils.rectangleBordered(x + 2.5, y + 2.5, (x1 + size) - 2.5, (y1 + size) - 2.5, 0.5, Colors2.getColor(61),
                Colors2.getColor(0));
        NRenderUtils.drawGradientSideways(x + size * 3, (y + 3.0f), x1 -  size * 2, y + 4, (int) color2, (int) color3);
    }
    ...
    public static void resetCaps() {
        glCapMap.forEach(NRenderUtils::setGlState);
    }
