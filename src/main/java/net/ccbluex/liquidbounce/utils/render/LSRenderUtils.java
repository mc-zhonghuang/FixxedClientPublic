...
public final class LSRenderUtils extends MinecraftInstance {
    ...
    public static void drawTexturedRect(float x, float y, float width, float height, String image) {
        ...
        mc.getTextureManager().bindTexture(new ResourceLocation("fixxed/shadow/" + image + ".png"));
        GlStateManager.color(1F, 1F, 1F, 1F);
        LSRenderUtils.drawModalRectWithCustomSizedTexture(x, y, 0, 0, width, height, width, height);
    ...
    public static void rectangleBordered(double x, double y, double x1, double y1, double width, int internalColor,
                                         int borderColor) {
        LSRenderUtils.rectangle(x + width, y + width, x1 - width, y1 - width, internalColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        LSRenderUtils.rectangle(x + width, y, x1 - width, y + width, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        LSRenderUtils.rectangle(x, y, x + width, y1, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        LSRenderUtils.rectangle(x1 - width, y, x1, y1, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        LSRenderUtils.rectangle(x + width, y1 - width, x1 - width, y1, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
    }
