...
public final class RenderUtils extends MinecraftInstance {
    ...
    public static void drawFastRoundedRect(final float x0, final float y0, final float x1, final float y1,
        ...
        final float f2 = new Color(24,255,255).getRGB();
        final float f3 = new Color(16,255,255).getRGB();
        final float f4 = new Color(8,255,255).getRGB();
        final float f5 = new Color(0,255,255).getRGB();
        GL11.glDisable(2884);
        GL11.glDisable(3553);
        GL11.glEnable(3042);
        GlStateManager.enableBlend();
    ...
    public static void drawEntityBox2(final Entity entity, final Color color, final boolean outline) {
        final RenderManager renderManager = mc.getRenderManager();
        final Timer timer = mc.timer;
