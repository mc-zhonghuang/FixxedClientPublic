...
@ModuleInfo(name = "Tower", category = ModuleCategory.WORLD, keyBind = Keyboard.KEY_O)
public class Tower extends Module {
    ...
    public void onMotion(final MotionEvent event) {
        ...
        if (eventState == EventState.PRE) {
            ...
            if (autoBlockValue.get() ? InventoryUtils2.findAutoBlockBlock() != -1 : mc.thePlayer.getHeldItem() != null
