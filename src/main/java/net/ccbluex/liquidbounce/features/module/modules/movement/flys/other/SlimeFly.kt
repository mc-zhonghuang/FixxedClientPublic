...
class SlimeFly : FlyMode("Slime") {
    private val hurtTickValue = FloatValue("hurtTick", 2.5f, 1f, 5f)
    ...
    override fun onPacket(event: PacketEvent) {
        ...
        if (packet is C03PacketPlayer && hurtTick > 0f) {
            if(spoofValue.get()) {
