...
class Aura : Module() {
    ...
    // AutoBlock
    val autoBlockValue = ListValue("AutoBlock", arrayOf("Range", "Fake","Press","Packet", "Off"), "Off")
    ...
    fun onMotion(event: MotionEvent) {
        ...
        if (blockTimingValue.equals("Both") ||
            ...
            if (target != null && autoBlockValue.get().equals("press")) {
                val playerDistance =
...
//    }
    ...
    /**
     * 攻击[实体]
    @当保护坏数据包时引发IllegalStateException
     */
    ...
    private fun startBlocking(interactEntity: Entity, interact: Boolean) {
        ...
        if (autoBlockValue.equals("Packet") && mc.thePlayer.getDistanceToEntityBox(interactEntity) > autoBlockRangeValue.get()) {
    ...
    override val tag: String
        get() = "AB-${autoBlockValue.get()} Range-${rangeValue.get()}"
    /*
