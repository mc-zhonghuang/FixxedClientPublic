...
class AutoTool : Module() {
    ...
    private val AutoWeaponValue = BoolValue("AutoWeapon",true);
    //autoweapon
    private val onlySwordValue = BoolValue("OnlySword", false).displayable { AutoWeaponValue.equals(true) }
    private val silentValue = BoolValue("SpoofItem", false).displayable { AutoWeaponValue.equals(true) }
    private val ticksValue = IntegerValue("SpoofTicks", 10, 1, 20).displayable { AutoWeaponValue.equals(true) }
