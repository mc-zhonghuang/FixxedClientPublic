...
//    public static GameFontRenderer font60;
    ...
    @FontDetails(fontName = "Smooth1-s", fontSize = 35, fileName = "smooth.ttf")
    public static GameFontRenderer fs35;

    @FontDetails(fontName = "Smooth1-m", fontSize = 40, fileName = "smooth.ttf")
    public static GameFontRenderer fs40;

    @FontDetails(fontName = "Icon", fontSize = 40, fileName = "icon.ttf")
    public static GameFontRenderer ICON;

    @FontDetails(fontName = "Hanabi", fontSize = 40, fileName = "Hanabi.ttf")
    public static GameFontRenderer Hanabi;

    @FontDetails(fontName = "Icons", fontSize = 40, fileName = "Moreicon.ttf")
    public static GameFontRenderer Icons;

    @FontDetails(fontName = "Smooth2-s", fontSize = 35, fileName = "smooth2.ttf")
    public static GameFontRenderer fss35;

    @FontDetails(fontName = "Smooth2-m", fontSize = 40, fileName = "smooth2.ttf")
    public static GameFontRenderer fss40;
